...
public class MyRequestsActivitiy extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_my_requests_activitiy);
        ...
        myAdapter2 adapter = new myAdapter2(this,obj);
